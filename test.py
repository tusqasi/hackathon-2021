...
while True:
    ...
    blur =cv2.GaussianBlur(grey,(3,)*2,0)
    ...
    _, masked = cv2.threshold(dilatata,50,255,cv2.ADAPTIVE_THRESH_MEAN_C)
    ...
    cv2.imshow('Video Origional',masked)
    # cv2.imshow('Dildata',blur)
